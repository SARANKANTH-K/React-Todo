...
mongoose.connect("mongodb+srv://sarankanthk21cse:i5L48ewT88kLb60Y@humongos.48ruj83.mongodb.net/?retryWrites=true&w=majority&appName=Humongos")
.then(() => {
...
// to run the nodemon liver server->npx nodemon index.js  <filename>